...
mfPkg.ready = function() {
    ...
    //console.log('mf ready changed to: ' + ready);
...
function updateSubs() {
    ...
    mfPkg.mfStringsSub
        ...
        mfPkg.lastSync[locale], false, function(){mfPkg.readyDep.changed()}); //additionally change the ready dep as it can be that there are deps on old subscriptions.
